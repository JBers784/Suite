...
{
    public class UtilesHerramientas
    {
        ...
        public UtilesHerramientas() { }

        public UtilesHerramientas(string Codigo, string Descripcion, decimal Existencia, string Um, string NombreAlmacen)
        {
            this.Codigo = Codigo;
        ...
        public List<UtilesHerramientas> ListaUH()
        {
            AlmacenesEntities entities = new AlmacenesEntities();
            List<UtilesHerramientas> resp = new List<UtilesHerramientas>();
            var consulta = (from munprod in entities.Mundo_Productos
                            ...
                            where (munprod.mProducto_Status == "H" && prodalmc.ProdAlm_Existencia != 0)
            ...
            {
                resp.Add(new UtilesHerramientas(item.Codigo, item.Descripcion, item.Existencia, item.Um, item.NombreAlmacen));
            }
            return resp;
        }
